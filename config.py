...
class Config(object):
    ...
    SQL_SERVER = os.environ.get('SQL_SERVER') or 'sqlcms1.database.windows.net'
    SQL_DATABASE = os.environ.get('SQL_DATABASE') or 'cmsSql'
    SQL_USER_NAME = os.environ.get('SQL_USER_NAME') or 'admincmssql'
    SQL_PASSWORD = os.environ.get('SQL_PASSWORD') or 'cmsadmin@1'
